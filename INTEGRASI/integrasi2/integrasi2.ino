...
void histogram(double vData[])
{
    ...
    for(j = 1; j <= 20; j++)
    {
      ...
      averageMagnitude[j] = averageMagnitude[j]*0.00059 + 65.1299;
    }
...
void histogramMagnitude(double magnitude[])
{
  ...
  for(i = 1; i <= 20; i++)
  {
    if(magnitude[i] <= 30)
    {
      y = 210;
      h = 10;
    }else if(magnitude[i] <= 40)
    {
      y = 200;
      h = 20;
    }else if(magnitude[i] <= 50)
    {
      y = 190;
      h = 30;
    }else if(magnitude[i] <= 60)
    {
      y = 180;
      h = 40;
    }else if(magnitude[i] <= 70)
    {
      y = 170;
      h = 50;
    }else if(magnitude[i] <= 80)
    {
      y = 160;
      h = 60;
    }else if(magnitude[i] <= 90)
    {
      y = 150;
      h = 70;
    }else if(magnitude[i] <= 100)
    {
      y = 140;
      h = 80;
    }else if(magnitude[i] <= 120)
    {
      y = 130;
      h = 90;
    }else
...
//    Serial.println(w);
//    Serial.println(x);
    Serial.print(magnitude[6]); Serial.println("Ini Magnitude ke 6");
    Serial.print(magnitude[7]); Serial.println("Ini Magnitude ke 7");
  }
